function clearAll() {
  ...
  const riddleContainer = document.querySelector(".riddleContainer");
...
function showRiddle() {
  ...
  const container = document.querySelector(".riddleContainer");
...
function revealAnswers() {
  ...
  const riddleContainer = document.querySelector(".riddleContainer");
  const haveRiddle = riddleContainer.querySelector("p");
  const haveAnswer = document.querySelector("#riddleAnswer");
  
  if(haveRiddle && haveAnswer.hidden){
    haveAnswer.hidden = false;
  }
  else if(haveRiddle){
    alert("You already have the answer for this riddle!");
  }
  else{
      alert("You need to have a riddle before the answer!");
    }
